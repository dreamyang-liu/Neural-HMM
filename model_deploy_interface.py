...
def parse_args():
    ...
    parser.add_argument(
        '--data_dir', type=str, default='toy-data.json',
        help='data location.'
    )
    parser.add_argument(
        '--config_dir', type=str, default='config.json',
...
def build_dataset(data_json_obj, args):
    # load data from disk
...
def get_model_predict(data_json_obj):
    args = parse_args()
    print(args)
    ...
    string_list, token_list, anno_list = build_dataset(data_json_obj, args)
    ...
    return str_span_list
        
if __name__ == '__main__':
    # data_str =  '''{"processedData": [{"sentence": "Net income was $9.4 million compared to the prior year of $2.7 million. \n", "annotation": [["span", "to", 28, 39], ["spam", "quantity", 20, 27], ["spam", "quantity", 63, 70], ["spam", "money", 15, 19], ["spam", "money", 58, 62]]}, {"sentence": "Revenue exceeded twelve billion dollars, with a loss of $1b.\n", "annotation": [["spam", "quantity", 24, 31], ["spam", "money", 32, 39], ["spam", "money", 56, 58]]}, {"sentence": "I am a doctor and I live in boston.\n", "annotation": []}, {"sentence": "\n", "annotation": []}, {"sentence": "Net income was $2.4 million compared to the prior year of $1.7 million. \n", "annotation": [["span", "to", 28, 39], ["spam", "quantity", 20, 27], ["spam", "quantity", 63, 70], ["spam", "money", 15, 19], ["spam", "money", 58, 62]]}, {"sentence": "Revenue exceeded twelve billion dollars, with a loss of $1b.\n", "annotation": [["spam", "quantity", 24, 31], ["spam", "money", 32, 39], ["spam", "money", 56, 58]]}, {"sentence": "I am a mechanic and I live in boston.\n", "annotation": []}, {"sentence": "\n", "annotation": []}, {"sentence": "Net income was $9.4 million compared to the prior year of $2.7 million. \n", "annotation": [["span", "to", 28, 39], ["spam", "quantity", 20, 27], ["spam", "quantity", 63, 70], ["spam", "money", 15, 19], ["spam", "money", 58, 62]]}, {"sentence": "Revenue exceeded twelve billion dollars, with a loss of $1b.\n", "annotation": [["spam", "quantity", 24, 31], ["spam", "money", 32, 39], ["spam", "money", 56, 58]]}, {"sentence": "I am a doctor and I live in boston.\n", "annotation": []}, {"sentence": "\n", "annotation": []}, {"sentence": "Net income was $2.4 million compared to the prior year of $1.7 million. \n", "annotation": [["span", "to", 28, 39], ["spam", "quantity", 20, 27], ["spam", "quantity", 63, 70], ["spam", "money", 15, 19], ["spam", "money", 58, 62]]}, {"sentence": "Revenue exceeded twelve billion dollars, with a loss of $1b.\n", "annotation": [["spam", "quantity", 24, 31], ["spam", "money", 32, 39], ["spam", "money", 56, 58]]}, {"sentence": "I am a mechanic and I live in boston.", "annotation": []}]}'''
    get_model_predict('')
